...
var providerRegistry = map[string]ProviderMeta{
	...
	"codebuddy-cn":   {ID: "codebuddy-cn", Name: "CodeBuddy CN", Alias: "cbcn", Category: CategoryOAuth, AuthType: "oauth", Description: "CodeBuddy CN developer session", Website: "https://copilot.tencent.com"},
	"codebuddy-intl": {ID: "codebuddy-intl", Name: "CodeBuddy", Alias: "cbai", Category: CategoryOAuth, AuthType: "oauth", Description: "CodeBuddy developer session", Website: "https://www.codebuddy.ai"},
	"workbuddy":      {ID: "workbuddy", Name: "WorkBuddy", Alias: "wb", Category: CategoryOAuth, AuthType: "oauth", Description: "Tencent WorkBuddy office-agent session", Priority: 15, Icon: "work", Color: "#0052D9", ServiceKinds: []string{"llm"}, Website: "https://www.workbuddy.ai"},
	...
	"gitlab":         {ID: "gitlab", Name: "GitLab Duo", Alias: "gitlab", Category: CategoryOAuth, AuthType: "oauth", Description: "GitLab Duo AI developer token", Website: "https://gitlab.com"},
	...
	"iflow":          {ID: "iflow", Name: "iFlow AI", Alias: "if", Category: CategoryOAuth, AuthType: "oauth", Description: "iFlow multi-model platform session", Website: "https://iflow.cn"},
	...
	"xiaomi-mimo":    {ID: "xiaomi-mimo", Name: "Xiaomi MiMo", Alias: "xiaomi-mimo", Category: CategoryAPIKey, AuthType: "apikey", Description: "Xiaomi MiMo API key from platform.xiaomimimo.com", Priority: 290, Icon: "smart_toy", Color: "#FF6900", ServiceKinds: []string{"llm", "tts"}, Website: "https://xiaomimimo.com"},
	...
	"coqui":         {ID: "coqui", Name: "Coqui TTS", Alias: "coqui", Category: CategoryFreeTier, AuthType: "none", Description: "Local Coqui TTS server", Website: "https://github.com/coqui-ai/TTS"},
	...
	"searxng":       {ID: "searxng", Name: "SearXNG", Alias: "searxng", Category: CategoryFreeTier, AuthType: "none", Description: "Self-hosted SearXNG search (no auth)", Website: "https://docs.searxng.org"},
	"tortoise":      {ID: "tortoise", Name: "Tortoise TTS", Alias: "tortoise", Category: CategoryFreeTier, AuthType: "none", Description: "Local Tortoise TTS server", Website: "https://github.com/neonjb/tortoise-tts"},
	...
	"api-airforce":  {ID: "api-airforce", Name: "API.airforce", Alias: "af", Category: CategoryFreeTier, AuthType: "apikey", Description: "API.airforce free gateway", Website: "https://api.airforce"},
	"bazaarlink":    {ID: "bazaarlink", Name: "Bazaarlink", Alias: "bzl", Category: CategoryFreeTier, AuthType: "apikey", Description: "Bazaarlink free gateway", Website: "https://bazaarlink.ai"},
	"kilo-gateway":  {ID: "kilo-gateway", Name: "Kilo Gateway", Alias: "kgw", Category: CategoryFreeTier, AuthType: "apikey", Description: "Kilo Gateway free tier", Website: "https://kilo.ai"},
	...
	"devin-cli":  {ID: "devin-cli", Name: "Devin CLI", Alias: "dv", Category: CategoryFree, AuthType: "none", Description: "Devin CLI via ACP/stdio — run `devin auth login` first", Priority: 55, Icon: "smart_toy", Color: "#6366F1", ServiceKinds: []string{"llm"}, Website: "https://cli.devin.ai"},
	"freebuff":   {ID: "freebuff", Name: "Freebuff", Alias: "fb", Category: CategoryFree, AuthType: "oauth", Description: "Free ad-supported coding agent by Codebuff", Priority: 45, Icon: "bolt", Color: "#84CC16", ServiceKinds: []string{"llm"}, Website: "https://freebuff.com"},
	...
	"mimo-free":  {ID: "mimo-free", Name: "MiMo Code Free", Alias: "mmf", Category: CategoryFree, AuthType: "none", Description: "Xiaomi MiMo Code free session — no credential needed", ServiceKinds: []string{"llm"}, Website: "https://xiaomimimo.com"},
	...
	"aws-polly":            {ID: "aws-polly", Name: "AWS Polly", Alias: "polly", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://aws.amazon.com/polly/"},
	...
	"brave-search":         {ID: "brave-search", Name: "Brave Search", Alias: "brave", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://brave.com/search/api"},
	"cartesia":             {ID: "cartesia", Name: "Cartesia", Alias: "cartesia", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://cartesia.ai"},
	...
	"comfyui":              {ID: "comfyui", Name: "ComfyUI", Alias: "comfyui", Category: CategoryAPIKey, AuthType: "none", Priority: 120, Icon: "account_tree", Color: "#4CAF50", ServiceKinds: []string{"image"}, Website: "https://github.com/comfyanonymous/ComfyUI"},
	...
	"firecrawl":            {ID: "firecrawl", Name: "Firecrawl", Alias: "firecrawl", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://firecrawl.dev"},
	...
	"google-pse":           {ID: "google-pse", Name: "Google PSE", Alias: "gpse", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://programmablesearchengine.google.com"},
	...
	"inworld":              {ID: "inworld", Name: "Inworld TTS", Alias: "inworld", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://inworld.ai"},
	"jina-ai":              {ID: "jina-ai", Name: "Jina AI", Alias: "jina", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://jina.ai"},
	"jina-reader":          {ID: "jina-reader", Name: "Jina Reader", Alias: "jina-reader", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://jina.ai/reader"},
	"linkup":               {ID: "linkup", Name: "Linkup", Alias: "linkup", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://linkup.so"},
	...
	"ollama-search":        {ID: "ollama-search", Name: "Ollama Search", Alias: "ollama-search", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://ollama.com"},
	...
	"playht":               {ID: "playht", Name: "PlayHT", Alias: "playht", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://play.ht"},
	...
	"sdwebui":              {ID: "sdwebui", Name: "SD WebUI", Alias: "sdwebui", Category: CategoryAPIKey, AuthType: "none", Priority: 110, Icon: "brush", Color: "#FF7043", ServiceKinds: []string{"image"}, Website: "https://github.com/AUTOMATIC1111/stable-diffusion-webui"},
	"searchapi":            {ID: "searchapi", Name: "SearchAPI", Alias: "searchapi", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://www.searchapi.io"},
	"serper":               {ID: "serper", Name: "Serper", Alias: "serper", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://serper.dev"},
	...
	"tavily":               {ID: "tavily", Name: "Tavily", Alias: "tavily", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://tavily.com"},
	...
	"topaz":                {ID: "topaz", Name: "Topaz", Alias: "topaz", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://topazlabs.com"},
	...
	"youcom":               {ID: "youcom", Name: "You.com Search", Alias: "youcom", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://you.com"},
	...
	"baidu":                {ID: "baidu", Name: "Baidu Qianfan", Alias: "qianfan", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://ernie.baidu.com/"},
	"bluesminds":           {ID: "bluesminds", Name: "BluesMinds", Alias: "bm", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://www.bluesminds.com"},
	"llm7":                 {ID: "llm7", Name: "LLM7", Alias: "llm7", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://llm7.io"},
	"sambanova":            {ID: "sambanova", Name: "SambaNova", Alias: "samba", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://sambanova.ai"},
	"tencent":              {ID: "tencent", Name: "Tencent Hunyuan", Alias: "hunyuan", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://hunyuan.tencent.com"},
	"morph":                {ID: "morph", Name: "Morph", Alias: "morph", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://morphllm.com"},
	"tokenrouter":          {ID: "tokenrouter", Name: "TokenRouter", Alias: "tokenrouter", Category: CategoryAPIKey, AuthType: "apikey", Website: "https://tokenrouter.com"},
...
// NoAuthProviders returns the registry providers the providers grid must show
// even though they own no connection row: keyless providers that serve chat
// completions (`AuthType == "none"` and `ServiceKinds` includes "llm"), sorted
// by ascending Priority then ID so the order is stable across calls.
//
// These never need a connection row, because there is nothing to store. Upstream
// says the same in `providerPageUtils.ts::filterConfiguredProviderEntries` —
// "no-auth providers never create a DB connection row (stats.total === 0) but are
// always usable … so they must not be hidden" (#3290), rendered by its dedicated
// "No Auth" section. The dashboard grid is built from connections, so without
// this list OpenCode Free is invisible until someone invents an account for it.
//
// The `llm` requirement is load-bearing, not decoration. `AuthType == "none"`
// alone also matches the local media/utility servers — `coqui`, `edge-tts`,
// `google-tts`, `local-device`, `tortoise` (text-to-speech) and `searxng`
// (search) — and promoting those onto the providers page would be wrong: they
// cannot serve a chat request, so a card for them is noise an operator cannot
// act on. Upstream keeps exactly this boundary, splitting them across catalog
// files: `noauth.ts` holds only LLM providers (opencode, duckduckgo-web,
// aihorde, …), while the TTS servers live in `audio.ts` and SearXNG in
// `search.ts`. The registry's own `ServiceKinds` is how we express the same
// split, and it happens to align: `opencode` is the sole no-auth entry declaring
// `["llm"]`.
//
// A no-auth provider that later gains a real connection stops being synthesised,
// because HandleListProviders only adds a card for ids it has not already seen.
func NoAuthProviders() []ProviderMeta {
	out := make([]ProviderMeta, 0, len(providerRegistry))
	for _, meta := range providerRegistry {
		if meta.AuthType != "none" {
			continue
		}
		if !slices.Contains(meta.ServiceKinds, "llm") {
			continue
		}
		out = append(out, meta)
	}
...
// IsNoAuthProvider reports whether a provider authenticates with no user-supplied
// credential. Such providers have no connection row at all, so every check that
// gates on "do we have a connection?" must also accept them — otherwise a
// provider the operator can plainly chat with looks broken.
func IsNoAuthProvider(id string) bool {
	if meta, ok := providerRegistry[id]; ok {
		if meta.AuthType == "none" {
			return true
		}
	}
	canonical := ResolveAlias(id)
	meta, ok := providerRegistry[canonical]
	return ok && meta.AuthType == "none"
}
